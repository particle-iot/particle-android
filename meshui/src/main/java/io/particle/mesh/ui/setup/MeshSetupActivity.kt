...
class MeshSetupActivity : ProgressHack,
    MeshFlowTerminator,
    AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flowVM.setNavController(NavigationToolImpl(navController))
    ...
    private fun onDialogSpecReceived(spec: DialogSpec?) {
            ...
            is ResDialogSpec? -> {
                ...
                spec.negativeText?.let {
                    ...
                    builder.onNegative { dialog, _ ->
                        dialog.dismiss()
                        flowVM.flowManager!!.updateDialogResult(NEGATIVE)
                    }
                }
        ...
        builder.canceledOnTouchOutside(false)
            .onPositive { dialog, _ ->
                dialog.dismiss()
                flowVM.flowManager!!.updateDialogResult(POSITIVE)
            }
